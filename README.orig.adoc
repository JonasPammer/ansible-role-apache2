...
`https://httpd.apache.org/docs/2.4/mod/core.html#serveralias[serveralias]` (optional)::

`https://httpd.apache.org/docs/2.4/mod/core.html#serveradmin[serveradmin]` (optional)::

`https://httpd.apache.org/docs/2.4/mod/core.html#documentroot[documentroot]` (optional)::

`documentroot__link:https://httpd.apache.org/docs/2.4/mod/core.html#servername[allowoverride]` (optional)::
...
`documentroot__link:https://httpd.apache.org/docs/2.4/mod/core.html#options[options]` (optional)::
...
https://httpd.apache.org/docs/current/mod/mod_ssl.html#sslcertificatefile[ssl_certificate_file]::
https://httpd.apache.org/docs/current/mod/mod_ssl.html#sslcertificatekeyfile[ssl_certificate_key_file]::
https://httpd.apache.org/docs/current/mod/mod_ssl.html#sslcertificatechainfile[ssl_certificate_chain_file] (optional)::
...
-----
* On initial install, a file with the name of `favicon.ico` will be placed into `/var/www/html`
if there was no file with said name before. This favicon resembles the Ansible logo
...
vars:
  apache_vhost_filename: "myvhost.conf"
  apache_vhosts:
    - servername: "srvcmk.intra.nesevo.com"
      extra_parameters: |
